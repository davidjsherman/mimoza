...
class page:
    ...
    def init( self, lang='en', css=None, metainfo=None, title=None, header=None,
              footer=None, charset=None, encoding=None, doctype=None, bodyattrs=None, script=None, base=None, fav=None ):
        ...
        fav     --  the faviicon to be added as <link rel='shortcut icon'
    ...
    def fav( self, filelist ):
        """This convenience function is only useful for html.
        It adds faviicon(s) to the document via the <link> element."""

        if isinstance( filelist, basestring ):
            self.link( href=filelist, rel='shortcut icon', type='image/x-icon')
        else:
            for file in filelist:
                self.link( href=file, rel='shortcut icon', type='image/x-icon')
